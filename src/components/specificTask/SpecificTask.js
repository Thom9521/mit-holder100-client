...
const SpecificTask = () => {
    ...
    return <div className="contentWrapper contentCenter ">
        <div className="taskWrapper listHeader">
            <div className="taskContent">
                <h5>{state.name}</h5>
                <p className="taskDeadline" style={{ color: dateColor }}>
                    {state.due_date !== null ? "Deadline: " + deadlineFormat : "Ingen deadline"}
                </p>
